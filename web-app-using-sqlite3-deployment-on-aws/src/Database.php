...
class Database
{
    ...
    public function insertRecette(
        ...
        if (
            ...
            $statement = $this->pdo->prepare('INSERT INTO recette (username, email, title, picture, descript) 
                    values (:username, :email, :title, :picture, :descript)');
    ...
    private function checkPicture(String $picture): bool{
        return $picture !== '' && strlen($picture) <= 100;
    }
